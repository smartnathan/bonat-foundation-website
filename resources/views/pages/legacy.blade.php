<x-layouts.site title="In Loving Memory — The Deborah Bonat Foundation">
    ...
    <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-dark">
        ...
        <div class="absolute top-4 right-4 bg-white/10 text-white/40 text-xs px-3 py-1 rounded-full font-mono hidden sm:block">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center py-20">
            ...
            <div class="flex items-center justify-center gap-4 mb-8">
                ...
                <span class="text-brand-gold/70 text-xs uppercase tracking-[0.3em] font-medium">In Memoriam</span>
                <div class="h-px bg-brand-gold/40 w-16 sm:w-24"></div>
            </div>
            ...
            <p class="mt-4 text-white/50 text-sm tracking-widest uppercase">
                [Birth Year] &ndash; [Year of Passing] &nbsp;|&nbsp; 29 Years of Widowhood &nbsp;|&nbsp; A Life Poured Out
            </p>
            ...
            <blockquote class="mt-10 max-w-2xl mx-auto">
                ...
                <footer class="mt-3 text-brand-gold/70 text-sm">&mdash; The Deborah Bonat Foundation</footer>
            </blockquote>

            <div class="mt-12 flex flex-col sm:flex-row gap-4 justify-center">
                <a href="#condolences"
                   class="inline-flex items-center justify-center px-8 py-3.5 bg-white/10 border border-white/20 text-white rounded-xl font-semibold text-sm hover:bg-white/20 transition-colors backdrop-blur-sm">
                    Leave a Tribute
                </a>
                <a href="#donate"
    ...
    <section class="py-20 bg-brand-cream">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white rounded-3xl shadow-sm border border-purple-100 p-8 sm:p-12 max-w-3xl mx-auto">
                ...
                <blockquote class="text-gray-700 text-lg leading-relaxed italic text-center">
    ...
    {{-- ============================================================
         CONDOLENCE WALL
    ============================================================ --}}
    <section id="condolences" class="py-20 bg-brand-cream scroll-mt-16">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="bg-white rounded-3xl p-8 shadow-sm border border-purple-100">
                    ...
                    <form action="{{ route('condolences.store') }}" method="POST" class="space-y-5">
                        @csrf

                        <div>
                            <label for="condolence_name" class="block text-sm font-medium text-gray-700 mb-1.5">Your Name <span class="text-red-400">*</span></label>
                            <input
                                type="text"
                                id="condolence_name"
                                name="name"
                        ...
                        <div>
                            <label for="condolence_email" class="block text-sm font-medium text-gray-700 mb-1.5">Email Address <span class="text-gray-400">(optional)</span></label>
                            <input
                                type="email"
                                id="condolence_email"
                                name="email"
                        ...
                        <div>
                            <label for="condolence_message" class="block text-sm font-medium text-gray-700 mb-1.5">Your Message <span class="text-red-400">*</span></label>
                            <textarea
                                ...
                                <div class="bg-white rounded-2xl p-5 border border-purple-100 shadow-sm">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-gray-400 text-xs mt-0.5">{{ $condolence->created_at->diffForHumans() }}</p>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 text-center">
            ...
            <div class="mt-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                @foreach([
                    ['🌿', 'Widows', 'programs.widows'],
                    ['📚', 'Orphans', 'programs.orphans'],
                    ['🤝', 'Elderly', 'programs.elderly'],
                    ['✝️', 'Missions', 'programs.missions'],
                    ['🕊️', 'New Converts', 'programs.new-converts'],
