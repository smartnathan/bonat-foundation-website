        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-3xl p-8 border border-purple-100 shadow-sm">
                    <h2 class="text-xl font-bold text-brand-purple mb-6">Send Us a Message</h2>
                    ...
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="tel" id="contact_phone" name="phone" value="{{ old('phone') }}" maxlength="30"
                                       class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple/30 focus:border-brand-purple"
                                       placeholder="+234 ...">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="contact_subject" name="subject" value="{{ old('subject') }}" required maxlength="150"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple/30 focus:border-brand-purple @error('subject') border-red-400 @enderror"
                        ...
                        <div>
                            ...
                            <textarea id="contact_message" name="message" required rows="5" maxlength="2000"
                                      class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-purple/30 focus:border-brand-purple resize-none @error('message') border-red-400 @enderror"
                ...
                <div class="space-y-8">
                    <div>
                        <h2 class="text-2xl font-bold text-brand-purple mb-6">Get in Touch</h2>
                        <div class="space-y-5">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-sm mt-0.5">[Foundation Address — TBC]<br>Jos, Plateau State, Nigeria</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-sm mt-0.5">[info@deborahbonatfoundation.org — TBC]</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-sm mt-0.5">[Phone number — TBC]</p>
                                </div>
                            </div>
                        </div>
                    </div>

                    <div class="bg-brand-purple rounded-2xl p-6 text-white">
                    ...
                    <div class="bg-brand-cream rounded-2xl p-6 border border-purple-100">
                        <p class="text-brand-purple font-semibold text-sm mb-2">Response Time</p>
