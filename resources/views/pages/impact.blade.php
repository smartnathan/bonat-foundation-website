<x-layouts.site title="Impact & Stories — The Deborah Bonat Foundation">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
                @foreach([
                    ...
                    <div class="bg-brand-cream rounded-2xl p-6 border border-purple-100">
                        <p class="text-3xl font-bold text-brand-purple">{{ $num }}</p>
    ...
    <section class="py-20 bg-brand-cream">
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl font-bold text-brand-purple">Success Stories</h2>
            </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl font-bold text-brand-purple">The Jos Relief Distributions</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                @foreach([
                    ...
                    <div class="bg-brand-cream rounded-2xl p-8 border border-purple-100 text-center">
                        ...
                        <h3 class="font-bold text-brand-purple text-lg">{{ $item }}</h3>
    ...
    <section class="py-20 bg-brand-purple/5 border-y border-purple-100">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <p class="text-brand-gold text-xs font-semibold uppercase tracking-widest mb-3">Annual Event</p>
                    <h2 class="text-3xl font-bold text-brand-purple">Voices of Grace Conference</h2>
