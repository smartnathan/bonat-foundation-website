            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="space-y-8">
                    <div class="bg-white rounded-2xl p-8 border border-purple-100 shadow-sm">
                        <h3 class="text-xl font-bold text-brand-purple mb-3">ECWA / EMS Churches</h3>
                    ...
                    <div class="bg-white rounded-2xl p-8 border border-purple-100 shadow-sm">
                        <h3 class="text-xl font-bold text-brand-purple mb-3">Any Bible-Believing Church</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">
                    ...
                    <div class="bg-white rounded-2xl p-8 border border-purple-100 shadow-sm">
                        <h3 class="text-xl font-bold text-brand-purple mb-3">Missions Organisations</h3>
                        <p class="text-gray-600 text-sm leading-relaxed">
                ...
                <div>
                    <div class="bg-brand-purple rounded-3xl p-8 text-white mb-8">
                        ...
                        <div class="space-y-4">
                            @foreach([
                                ...
                                <div class="flex gap-4">
                                    <div class="w-8 h-8 rounded-full bg-brand-gold flex items-center justify-center text-brand-purple font-bold text-sm shrink-0">{{ $num }}</div>
                                    <div>
                    ...
                    <blockquote class="bg-brand-cream rounded-2xl p-6 border border-purple-100">
                        <p class="text-brand-purple italic leading-relaxed">
