            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
                ...
                <a href="{{ route('get-involved.donate') }}"
                   class="group bg-white rounded-3xl p-8 border border-purple-100 shadow-sm hover:shadow-md hover:border-brand-gold/40 transition-all flex flex-col">
                    ...
                    <h3 class="text-xl font-bold text-brand-purple group-hover:text-brand-gold transition-colors">Donation Portal</h3>
                    ...
                    <p class="mt-5 text-brand-purple text-sm font-semibold group-hover:text-brand-gold transition-colors flex items-center gap-1">
                ...
                <a href="{{ route('get-involved.volunteer') }}"
                   class="group bg-white rounded-3xl p-8 border border-purple-100 shadow-sm hover:shadow-md hover:border-brand-gold/40 transition-all flex flex-col">
                    <div class="w-14 h-14 rounded-xl bg-brand-purple/10 flex items-center justify-center text-2xl mb-5">🤝</div>
                    <h3 class="text-xl font-bold text-brand-purple group-hover:text-brand-gold transition-colors">Volunteer Hub</h3>
                    <p class="mt-3 text-gray-500 text-sm leading-relaxed flex-grow">
                ...
                <a href="{{ route('get-involved.corporate') }}"
                   class="group bg-white rounded-3xl p-8 border border-purple-100 shadow-sm hover:shadow-md hover:border-brand-gold/40 transition-all flex flex-col">
                    <div class="w-14 h-14 rounded-xl bg-brand-purple/10 flex items-center justify-center text-2xl mb-5">🏢</div>
                    <h3 class="text-xl font-bold text-brand-purple group-hover:text-brand-gold transition-colors">Corporate Partnerships</h3>
                    <p class="mt-3 text-gray-500 text-sm leading-relaxed flex-grow">
                ...
                <a href="{{ route('get-involved.faith') }}"
                   class="group bg-white rounded-3xl p-8 border border-purple-100 shadow-sm hover:shadow-md hover:border-brand-gold/40 transition-all flex flex-col">
                    <div class="w-14 h-14 rounded-xl bg-brand-purple/10 flex items-center justify-center text-2xl mb-5">✝️</div>
                    <h3 class="text-xl font-bold text-brand-purple group-hover:text-brand-gold transition-colors">Faith-Based Collaboration</h3>
                    <p class="mt-3 text-gray-500 text-sm leading-relaxed flex-grow">
