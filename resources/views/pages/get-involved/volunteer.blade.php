        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-white rounded-3xl p-8 border border-purple-100 shadow-sm">
                    <h2 class="text-xl font-bold text-brand-blue mb-6">Volunteer Sign-Up</h2>
                    ...
                    <form action="{{ route('get-involved.volunteer.store') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="tel" id="vol_phone" name="phone" value="{{ old('phone') }}" required maxlength="30"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue @error('phone') border-red-400 @enderror"
                                   placeholder="+234 ...">
                        ...
                        <div>
                            ...
                            <input type="text" id="vol_location" name="location" value="{{ old('location') }}" required maxlength="150"
                                   class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue @error('location') border-red-400 @enderror"
                        ...
                        <div>
                            ...
                            <select id="vol_pillar" name="pillar" required
                                    class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue @error('pillar') border-red-400 @enderror">
                        ...
                        <div>
                            ...
                            <textarea id="vol_skills" name="skills" required rows="4" maxlength="1000"
                                      class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand-blue/30 focus:border-brand-blue resize-none @error('skills') border-red-400 @enderror"
                ...
                {{-- Why Volunteer --}}
                <div>
                    <h2 class="text-2xl font-bold text-brand-blue mb-8">Why Volunteer?</h2>
                    <div class="space-y-6">
                        @foreach([
                            ...
                            <div class="flex gap-4">
                                <div class="w-12 h-12 rounded-xl bg-brand-blue/10 flex items-center justify-center text-xl shrink-0">{{ $icon }}</div>
                                <div>
                    ...
                    <div class="mt-10 bg-brand-blue rounded-2xl p-6 text-white">
