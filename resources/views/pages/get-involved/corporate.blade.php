    ...
    <section class="py-20 bg-brand-cream">
        <div class="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div class="text-center mb-14">
                <h2 class="text-3xl font-bold text-brand-blue">Partner with a Pillar</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
                @foreach([
                    ...
                    <div class="bg-white rounded-2xl p-8 border border-purple-100 shadow-sm text-center">
                        ...
                        <h3 class="font-bold text-brand-blue text-lg">{{ $tier }}</h3>
                        <p class="mt-3 text-gray-500 text-sm leading-relaxed">{{ $desc }}</p>
                    </div>
                @endforeach
            </div>

            <div class="bg-brand-blue rounded-3xl p-8 sm:p-12 text-center text-white">
