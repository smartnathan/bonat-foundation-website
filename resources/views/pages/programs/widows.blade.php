        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white rounded-3xl p-8 sm:p-12 border border-purple-100 shadow-sm mb-10">
                <div class="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-brand-purple">Widows to Workers (W2W)</h2>
            ...
            <div x-data="{ open: null }" class="bg-white rounded-3xl border border-purple-100 shadow-sm overflow-hidden">
                <h3 class="text-lg font-bold text-brand-purple p-8 pb-4">Frequently Asked Questions</h3>
                @foreach([
                    ...
                    <div class="border-t border-gray-100">
                        <button
                            ...
                            class="w-full flex items-center justify-between px-8 py-5 text-left font-semibold text-gray-800 hover:text-brand-purple transition-colors"
                        >
                            <span>{{ $q }}</span>
                            <svg class="w-5 h-5 text-brand-purple shrink-0 transition-transform" :class="open === {{ $i }} ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
